    ...
    return (
      <Layout>
        <div className="contactNumbers">
          <div className="contactNumberText">
            <img src="https://srzd.com/dashboard/wp-content/uploads/2024/04/calm.png" alt="ALGUMA IMAGEM" className="contactNumberTextImg" />
            <div className="contactNumebrTextInfos">
              <h1>Suporte</h1>
              <p>Algum questionamento ou precisa de assistencia? Venha até nós!</p>
            </div>
          </div>
          <div className="contactNumberButtons">
